  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (response.status === 201) {
          setMessage({ text: "Signup successful! Awaiting admin approval.", type: "success" });
            ...
            >
              <div className="form-floating mb-3">
                <input
                  ...
                  required
                />
                <label htmlFor="floatingInput">Enter your Name <span className="text-danger">*</span></label>
              </div>
              <div className="form-floating mb-3">
                <input
                  type="DATE"
                  ...
                  required
                />
                <label htmlFor="floatingInput">Enter your DOB <span className="text-danger">*</span></label>
              </div>
              <div className="form-floating mb-3">
                <input
                  type="text"
                  ...
                  required
                />
                <label htmlFor="floatingInput">Enter your Phone <span className="text-danger">*</span></label>
              </div>
              <div className="form-floating mb-3">
                <select
                ...
                <label htmlFor="floatingSelect">Gender <span className="text-danger">*</span></label>
              </div>
              ...
              <div className="form-floating mb-3">
                <input
                  ...
                  required
                />
                <label htmlFor="floatingInput">Enter your Email<span className="text-danger">*</span></label>
              </div>
